...
class ConfigLagrange():
    @staticmethod
    def arguments_parser(parser = None) -> ArgumentParser:
        if not parser:
            parser = ArgumentParser(description="Parser for Lagrange environment")
        parser.add_argument("--input_cols", type=str, nargs='+',
                            default=["distance_b1_b2", "d"],
                            help="Features for symbolic regression")
        parser.add_argument("--output_col", type=str, default= None,
        ...
        parser.add_argument("--success_thr", type=float, default= 0.9,
        ...
        parser.add_argument('--sparse_p', type=float, default=0.1,
